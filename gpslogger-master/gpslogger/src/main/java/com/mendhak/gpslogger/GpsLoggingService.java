...
public class GpsLoggingService extends Service  {
    ...
    void onLocationChanged(Location loc) {
        ...
        writeToFile(loc);
        sendLocationToSNOW(String.valueOf(loc.getLatitude()),String.valueOf(loc.getLongitude()));
    ...
    public void sendLocationToSNOW(final String latitude, final String longitude ) {
